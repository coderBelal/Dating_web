  ...
  return (
    <nav className=" bg-gradient-to-r from-purple-100 via-purple-400 to-purple-300 px-4 py-3 shadow-sm">
      ...
      Home
          ...
          <Link to={'/contact'} className="text-gray-700 hover:text-purple-800">
             Contact
          </Link>
        </div>
     ...
     <Link to={"/login"} class="rounded relative inline-flex group items-center justify-center px-3.5 py-2 m-1 cursor-pointer border-b-4 border-l-2 active:border-purple-600 active:shadow-none shadow-lg bg-gradient-to-tr from-purple-600 to-purple-500 border-purple-700 text-white">
